...
describe("Soporte Interno", () => {
  ...
  it("Validación de activos al correo", () => {
    ...
    // cy.wait(2000);
    // cy.get('#descripcion').type("Necesito esta plataforma1");
    // cy.wait(2000);
    ...
    // cy.wait(2000);
    // cy.get('#conclusiones').type("Se Aprueba petición1");
    // cy.wait(2000);
    ...
    // cy.get('.odd > [style="text-align:center"] > form > [type="button"]').click();
    // cy.wait(2000);
    // cy.get('#nombre_usuario0').type("Prueba1");
    // cy.wait(2000);
    // cy.get('#clave0').type("Prueba1");
    // cy.wait(2000);
    ...
    // cy.get('#plataformas212').check();
    // cy.wait(2000);
    // cy.get('#descripcion').type("Ya no la necesito esta plataforma1");
    // cy.wait(2000);
    // cy.get('#crear_peticion_accesos').click();
    // cy.wait(2000);
    // cy.get(':nth-child(5) > #dropdownMenuButton').click();
