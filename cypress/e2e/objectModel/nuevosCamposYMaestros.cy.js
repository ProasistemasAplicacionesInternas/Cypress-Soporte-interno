...
describe("Verificar Login", () => {
  Cypress.on("uncaught:exception", (err, runnable) => {
    ...
    it('opcion izquierda', () => {
      ...
      cy.wait(2000);
      cy.get('#af_codigo').type("2587648156");
      cy.wait(2000);
      cy.get('#af_serial').type("10101087594");
      cy.wait(2000);
      cy.get('#af_marca').type("HP_kuks");
      cy.wait(2000);
      cy.get('#af_modelo').type("AL-19.20");
      cy.wait(2000);
      cy.get('#af_nombre').type("AsusNet12");
      cy.wait(2000);
      cy.get('#af_fechaCompra').clear();
      cy.wait(2000);
      cy.get('#af_fechaCompra').type("2024-05-10");
      cy.wait(2000);
      ...
      cy.wait(2000);
      cy.get('#costoCompra').type("960785000");
      cy.wait(2000);
      ...
      cy.wait(2000);
      cy.get('#m_fecha').type("2024-05-10");
      cy.wait(2000);
