...
describe("Verificar Login", () => {
  Cypress.on("uncaught:exception", (err, runnable) => {
    ...
    it('opcion izquierda', () => {
      ...
      cy.wait(2000);
      cy.get('#m_descripcion').type("Ingresamos la nueva observacion, En este caso por prueba Cypress 15");
      cy.wait(2000);
